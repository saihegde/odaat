...
public class JobResourceIntTest {
    ...
    private static final Instant DEFAULT_JOB_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_JOB_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
     ...
     *
     * @see com.anchormind.odaat.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createJob() throws Exception {
        ...
        assertThat(testJob.getJobDate()).isEqualTo(DEFAULT_JOB_DATE);
        assertThat(testJob.getPay()).isEqualTo(DEFAULT_PAY);
    ...
    public void updateJob() throws Exception {
        ...
        assertThat(testJob.getJobDate()).isEqualTo(UPDATED_JOB_DATE);
        assertThat(testJob.getPay()).isEqualTo(UPDATED_PAY);
