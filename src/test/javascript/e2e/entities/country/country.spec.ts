...
describe('Country e2e test', () => {
    ...
    it('should load Countries', async () => {
        ...
        expect(await countryComponentsPage.getTitle()).toMatch(/odaatApp.country.home.title/);
    });
    ...
    it('should load create Country page', async () => {
        ...
        expect(await countryUpdatePage.getPageTitle()).toMatch(/odaatApp.country.home.createOrEditLabel/);
    ...
    it('should delete last Country', async () => {
        ...
        expect(await countryDeleteDialog.getDialogTitle()).toMatch(/odaatApp.country.delete.question/);
