package com.anchormind.odaat.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("odaat");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("odaat");
        ...
        config.getMapConfigs().put("com.anchormind.odaat.domain.*", initializeDomainMapConfig(jHipsterProperties));
